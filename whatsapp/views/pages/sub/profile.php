    ...
    <div class="chat-message-detail wa-scroll px-4 m-t-30 p-b-25">
    	<div class="text-center">
    		<div class="mb-4 profile-user">
	    		<img src="<?php _e( (isset($result->avatar) && $result->avatar)?$result->avatar:get_avatar($result->pushname))?>" alt="" class="rounded-circle avatar-lg img-thumbnail">
	    	</div>
	    	<h5 class="font-size-16 mb-1 text-truncate"> <?php _e( $result->pushname )?> </h5>
	    	<p class="text-muted text-truncate mb-1"> <?php _e( $result->me->user )?> </p>
        ...
        <ul class="list-group m-t-50">
		  	...
		  	<li class="list-group-item d-flex justify-content-between align-items-center">
		    	<?php _e("Platform")?>
		    	<span class="badge badge-success badge-pill"><?php _e($result->platform)?></span>
		  	</li>
		  	<li class="list-group-item d-flex justify-content-between align-items-center">
		    	<?php _e("Whatsapp version")?>
		    	<span class="badge badge-success badge-pill"><?php _e($result->phone->wa_version)?></span>
		  	</li>
		  	<li class="list-group-item d-flex justify-content-between align-items-center">
		    	<?php _e("OS Version")?>
		    	<span class="badge badge-success badge-pill"><?php _e($result->phone->os_version)?></span>
		  	</li>
		  	<li class="list-group-item d-flex justify-content-between align-items-center">
		    	<?php _e("Device manufacturer")?>
		    	<span class="badge badge-success badge-pill"><?php _e($result->phone->device_manufacturer)?></span>
		  	</li>
		  	<li class="list-group-item d-flex justify-content-between align-items-center">
		    	<?php _e("Device model")?>
		    	<span class="badge badge-success badge-pill"><?php _e($result->phone->device_model)?></span>
		  	</li>
