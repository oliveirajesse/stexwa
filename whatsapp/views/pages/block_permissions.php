<div class="form-group">
	...
	<div>
		...
		<label class="i-checkbox i-checkbox--tick i-checkbox--brand m-r-10">
			<input type="checkbox" name="permissions[whatsapp_chat]" <?php _e( permission('checkbox', 'whatsapp_chat')  == 1?"checked":"" )?> value="1"> <?php _e('Chat')?>
			<span></span>
		</label>
		<label class="i-checkbox i-checkbox--tick i-checkbox--brand m-r-10">
...
<div class="form-group">
	<label class="fw-6 text-info"><?php _e('Chat permissions')?></label>
	<div>
		<label class="i-checkbox i-checkbox--tick i-checkbox--brand m-r-10">
			<input type="checkbox" name="permissions[whatsapp_chat_text]" <?php _e( permission('checkbox', 'whatsapp_chat_text')  == 1?"checked":"" )?> value="1"> <?php _e('Send text message')?>
			<span></span>
		</label>
		<label class="i-checkbox i-checkbox--tick i-checkbox--brand m-r-10">
			<input type="checkbox" name="permissions[whatsapp_chat_media]" <?php _e( permission('checkbox', 'whatsapp_chat_media')  == 1?"checked":"" )?> value="1"> <?php _e('Send media message')?>
			<span></span>
		</label>
	</div>
</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="form-group">
			...
			<div class="fs-12 text-info"><?php _e("Include the total number of messages sent by Chat, Bulk messages, Auto response, Chatbot")?></div>
