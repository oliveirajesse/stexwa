...
<div class="float-left fs-12 m-t-5 wa-info d-none">
	<div class="media">
	  	...
	  	<div class="media-body">
		    ...
		    <div class="detail">
				<span><i class="ri-router-line text-warning"></i> <?php _e("State:")?></span> <span class="state text-success fw-6"><?php _e("CONNECTED")?></span><span class="m-r-10"></span><span><i class="ri-battery-charge-fill position-relative t-2 text-danger"></i> <?php _e("Battery: ")?></span> <span class="battery text-success fw-6">100</span>
			</div>
	  	</div>
	</div>
</div>